        ...
        14: function(e, t, a) {
            ...
            var n = a(0),
                ...
                w = [
                        ...
                        {content: "Pirated CAD software?", weight: 1, type: 2},
                        {content: "thought sin(x) = x?", weight: 1, type: 2},
                        {content: "Reversed the polarity of an electrical component?", weight: 1, type: 2},
                        {content: "Reversed the polarity of an electrical component and damaged something?", weight: 1, type: 2},
                        {content: "Used red wires for negative and black wires for positive?", weight: 3, type: 2},
                        {content: "Short circuited something?", weight: 2, type: 2},
                        {content: "Disintegrated a wire?", weight: 2, type: 2},
                        {content: "Been zapped?", weight: 1, type: 2},
                        {content: "Been electrocuted?", weight: 2, type: 2},
                        {content: "Been violently electrocuted?", weight: 3, type: 2},
                        {content: "Worked on hardware without a way to safely discharge electricity?", weight: 1, type: 2},
                        {content: "Damaged hardware from a discharge?", weight: 4, type: 2},
                        {content: "Destroyed a logic analyzer/oscilloscope", weight: 4, type: 2},
                        {content: "Melted PCB/equipment/components?", weight: 2, type: 2},
                        {content: "Burned your hand while soldering?", weight: 1, type: 2},
                        {content: "Burned your hand with a hot glue gun?", weight: 1, type: 2},
                        {content: "Soldered incorrectly and destroyed the circuit?", weight: 2, type: 2},
                        {content: "Started a fire by soldering?", weight: 2, type: 2},
                        {content: "Welded without a respirator?", weight: 1, type: 2},
                        {content: "Welded without safety apparel?", weight: 2, type: 2},
                        {content: "Welded without a hood?", weight: 3, type: 2},
                        {content: "Broken a gear train?", weight: 1, type: 2},
                        {content: "Pinched skin in a gear train?", weight: 1, type: 2},
                        {content: "Exhausted a motor in a gear train?", weight: 1, type: 2},
                        {content: "Been hit by a motor?", weight: 2, type: 2},
                        {content: "Been hit by an actuator/hydraulics?", weight: 2, type: 2},
                        {content: "Been hit by pneumatics?", weight: 3, type: 2},
                        {content: "Broken equipment by any of the above three?", weight: 2, type: 2},
                        {content: "Broken a bone by any of the above three?", weight: 3, type: 2},
                        {content: "Printed something phallic/inappropriate in a 3D printer?", weight: 2, type: 2},
                        {content: "Printed a weapon/weapon part with a 3D printer?", weight: 2, type: 2},
                    ...
                    return Object(l.a)(a, [{
                        ...
                        value: function() {
                            ...
                            return s.a.createElement("div", {
                                ...
                                className: "col"
                            }, s.a.createElement("h4", null, this.props.w1 + '/' +t1 + '(' + (100 - (C1/W1*100).toFixed(1)) + '%)'), s.a.createElement("h6", {
                                className: "text-info mb-0"
                            }, "Science Offenses"), t > 0 && s.a.createElement("small", {
                                className: "text-muted font-weight-bold"
                            }, a.toFixed(1), "%")), s.a.createElement("div", {
                                className: "col"
                            }, s.a.createElement("h4", null, this.props.w2 + '/' +t2 + '(' + (100 - (C2/W2*100).toFixed(1)) + '%)'), s.a.createElement("h6", {
                                className: "text-primary mb-0"
                            }, "Technology Offenses"), t > 0 && s.a.createElement("small", {
                                className: "text-muted font-weight-bold"
                            }, i.toFixed(1), "%")), s.a.createElement("div", {
                                className: "col"
                            }, s.a.createElement("h4", null, this.props.w3 + '/' +t3 + '(' + (100 - (C3/W3*100).toFixed(1)) + '%)'), s.a.createElement("h6", {
                                ...
                                className: "col"
                            }, s.a.createElement("h4", null, this.props.w4 + '/' +t4 + '(' + (100 - (C4/W4*100).toFixed(1)) + '%)'), s.a.createElement("h6", {
                                className: "text-warning mb-0"
                            }, "Mathematic Offenses"), t > 0 && s.a.createElement("small", {
                                className: "text-muted font-weight-bold"
                            }, c.toFixed(1), "%")), s.a.createElement("div", {
                                className: "col"
                            }, s.a.createElement("h4", null, this.props.w5 + '/' +t5 + '(' + (100 - (C5/W5*100).toFixed(1)) + '%)'), s.a.createElement("h6", {
