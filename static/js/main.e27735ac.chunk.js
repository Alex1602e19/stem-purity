                ...
                b = function(e) {
                    ...
                    return Object(l.a)(a, [{
                        ...
                        value: function() {
                            ...
                            return s.a.createElement("div", {
                            ...
                            }, this.props.w1 + '/' +t1 + '(' + a.toFixed(1) + "%" + ')' )), s.a.createElement("div", {
                                className: "col"
                                ...
                                className: "text-muted font-weight-bold"
                            }, this.props.w2 + '/' +t2 + '(' + i.toFixed(1) + "%" + ')' )), s.a.createElement("div", {
                                className: "col"
                                ...
                                className: "text-muted font-weight-bold"
                            }, this.props.w3 + '/' +t3 + '(' + o.toFixed(1) + "%" + ')' ))), s.a.createElement("div", {
                                className: "row text-center"
                            }, s.a.createElement("div", {
                                className: "col"
                                ...
                                className: "text-muted font-weight-bold"
                            }, this.props.w4 + '/' +t4 + '(' + c.toFixed(1) + "%" + ')' )), s.a.createElement("div", {
                                className: "col"
                                ...
                                className: "text-muted font-weight-bold"
                            }, this.props.w5 + '/' +t5 + '(' + r.toFixed(1) + "%" + ')' ))), t > 0 && s.a.createElement(n.Fragment, null, s.a.createElement("hr", null), s.a.createElement("ul", {
